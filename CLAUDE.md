...
- `_sass/` — 样式模块，通过 `assets/css/style.scss` 统一导入：variables → base → layout → components → responsive
- `assets/js/navigation.js` — 目录导航脚本，扫描 `.main-content` 中的 h2/h3 动态生成 TOC 面板
